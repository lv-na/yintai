...
var rightType=document.querySelectorAll(".son");
	...
	// var re = $(".re")[0];
	// var le = $(".le")[0];
	// var d=setInterval(dong, 2000)
	// function dong(type) {
	// 	var type=type||"re";//判断type初始值
	// 		if (type=="re") {
	// 			c++;
	// 		    if (c>=dians.length) {
	// 			    c=0;
	...
	// 		animate(img[i],{opacity:0},400)
	// 		dians[i].style.background = "#3e3e3e";
	// 	}
	// 	animate(img[c],{opacity:1},400)
	// 	dians[c].style.background = "#b61b1f";
	// }
	// boxs.onmouseover = function() {
	// 	clearInterval(d)
	// }
	// boxs.onmouseout = function() {
	// 	d = setInterval(dong, 2000)
	// }
	...
	// 		animate(img[this.index],{opacity:1},400)
	// 	}
	// }
	// re.onclick = function() {
	// 	dong("re")
	...
	// var xlb = document.querySelectorAll(".zongtu"); //获取图片的大框
	// for (var i = 0; i < xlb.length; i++) {
	// 	jiedian(xlb[i])
	// }
